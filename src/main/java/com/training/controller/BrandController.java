...
public class BrandController {
	...
	@PostMapping(value = {"api/brandList"})
	@ResponseBody
	public Map<String, Object> brandList (@RequestBody  Map<String, Object> conditionsMap) {
		return brandService.findAllApi(conditionsMap);
	}
}